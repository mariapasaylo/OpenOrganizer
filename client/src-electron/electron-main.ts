...
import * as up from "app/src-electron/services/syncup";
...
function init() {
  ...
  void up.syncUp(); // syncup on startup todo: check if user has an account and is logged in before syncup is called
}
